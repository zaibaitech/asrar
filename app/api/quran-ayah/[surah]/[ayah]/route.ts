 ...
 * ayah's Arabic text, used by the calculator's Qur'anic Resonance result.
 * Returns { text: null } rather than an error status on any upstream
 * failure, so the caller can show an honest "couldn't load the verse text"
 * message alongside the still-valid Quran.com link.
 */
