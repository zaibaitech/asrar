        ...
        headers: [
          // Content Security Policy - Prevent XSS and data injection attacks
          {
            ...
            value: [
              ...
              "connect-src 'self' https://azjgakbhovanweelkezt.supabase.co wss://azjgakbhovanweelkezt.supabase.co https://api.supabase.co https://generativelanguage.googleapis.com https://nominatim.openstreetmap.org https://api.quran.com https://api.alquran.cloud https://vercel.live https://*.vercel.live https://asrar.app.com", // Add Supabase, Google AI, OpenStreetMap, Quran APIs, Vercel Live, and production domain
