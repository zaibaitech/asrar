...
import { Heart, Users, Sparkles, Info, ChevronDown, ChevronUp } from 'lucide-react';
    ...
    <div className="space-y-8 p-8 bg-white dark:bg-slate-900 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700">
      ...
      <div className="space-y-5">
        <button
          ...
          className="w-full flex items-center justify-between p-5 bg-gradient-to-r from-purple-50 to-rose-50 dark:from-purple-900/20 dark:to-rose-900/20 rounded-xl border border-purple-200 dark:border-purple-800 hover:shadow-md transition-all group"
        >
