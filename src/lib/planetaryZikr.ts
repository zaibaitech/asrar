...
export const PLANETARY_ZIKR: Record<string, PlanetZikr> = {
  ...
  jupiter: {
    ...
    zikr: [
      { name: 'Ya Muhayminu', arabicName: 'يَا مُهَيْمِنُ', count: '135', benefit: 'Divine protection and guardianship.', benefitFr: 'Protection divine et sauvegarde.' },
      { name: 'Ya Halimu', arabicName: 'يَا حَلِيمُ', count: '150', benefit: 'Attracting favour and softening hearts (Taskhīr).', benefitFr: 'Attirer la faveur et adoucir les cœurs (Taskhīr).' },
      { name: 'Ya Muhsi', arabicName: 'يَا مُحْصِي', count: '117', benefit: 'Divine accounting and precision.', benefitFr: 'Comptabilité divine et précision.' },
      { name: "Ya Sami'u", arabicName: 'يَا سَمِيعُ', count: '180', benefit: 'Having prayers answered (Ijābah).', benefitFr: "Obtenir l'exaucement des prières (Ijābah)." },
      { name: 'Ya Mutakabbiru', arabicName: 'يَا مُتَكَبِّرُ', count: '662', benefit: 'Commanding respect and dignified presence (Haybah).', benefitFr: 'Inspirer le respect et une présence digne (Haybah).' },
      { name: "Ya 'Azizu", arabicName: 'يَا عَزِيزُ', count: '93', benefit: 'Strength in leadership and personal growth.', benefitFr: 'Force dans le leadership et la progression personnelle.' },
      { name: 'Ya Muhayminu', arabicName: 'يَا مُهَيْمِنُ', count: '108', benefit: 'Restoring respect and reclaiming what is rightfully yours.', benefitFr: 'Rétablir le respect et récupérer ce qui vous revient de droit.' },
      { name: 'Ya Baqi', arabicName: 'يَا بَاقِي', count: '113', benefit: 'Career stability and establishing firm authority.', benefitFr: 'Stabilité professionnelle et autorité solide.' },
    ],
  },
