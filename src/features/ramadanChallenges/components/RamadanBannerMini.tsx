...
export function RamadanBannerMini({ language = 'en' }: RamadanBannerMiniProps) {
  ...
  const { state, addChallenge, getTotalTodayProgress, getTotalRamadanProgress } = useRamadanChallenges();
  ...
  // Don't render if not mounted or not Ramadan
        ...
        <div className="flex items-center gap-3 flex-1 min-w-0">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs sm:text-sm text-amber-700 dark:text-amber-300">
              ...
              {' · '}{t.total}: <span className="font-semibold">{formatNumber(totalRamadanProgress)}</span>
