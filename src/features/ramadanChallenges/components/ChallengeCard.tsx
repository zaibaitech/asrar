              ...
              <div className="mt-3 space-y-3 animate-in slide-in-from-top-2 duration-200">
                ...
                <div className="flex gap-2 w-full min-w-0">
                  <input
                    ...
                    className="flex-1 min-w-0 px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500"
                    min="1"
                  ...
                  <button
                    ...
                    className="flex-shrink-0 min-w-[72px] px-4 py-2 rounded-lg bg-amber-600 hover:bg-amber-700 disabled:bg-slate-300 dark:disabled:bg-slate-600 text-white font-medium text-sm transition-colors disabled:cursor-not-allowed"
                  >
