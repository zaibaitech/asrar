/**
 * General Arabic text abjad analysis — the core of the "Calculator" feature.
 * Per-letter elemental classification, the sirr/wusta/kamal/bast secondary
 * values, and letter-frequency analytics, layered on the core Kabīr/Ṣaghīr
 * math plus zodiac/divine-name/sacred-number correspondences.
 */
...
/** Maghribi elemental classification — 7 letters per element (ʿIlm al-Ḥurūf). */
...
// ============================================================================
// TYPE-SPECIFIC INSIGHTS (Name / Phrase / Dhikr)
// ============================================================================
...
/** Only surfaced when within 10 of a sacred number. */
