 ...
 * from the nearest-numerical-value Divine Name matching in divineNames.ts.
 *
 * Algorithm: reduce the name's Kabīr total into a 1-28 index (28 = the
 * number of letters in the Arabic alphabet), then look up the letter/Divine
 * Name traditionally associated with that position in the cycle.
 */
...
import type { TriText } from './i18nText';
...
/** 28-entry table, indexed 1-28 by resonance index. */
 ...
 * entry. Returns null when the text has no valid Arabic letters.
 */
